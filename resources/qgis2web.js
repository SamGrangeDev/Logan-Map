...
map.getView().fit([17004854.404059, -3237815.314153, 17071045.753700, -3203166.256941], map.getSize());
...
function onPointerMove(evt) {
	...
	if (doHighlight) {
        if (currentFeature !== highlight) {
          ...
          if (
            highlight &&
            featureOverlay.getSource().getFeatures().includes(highlight)
          ) {
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Logan Map</h2>';
        return titleElement;
    })(),
